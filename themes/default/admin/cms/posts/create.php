...
<div class="space-y-5">
    <div class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-slate-800">Add New Post</h1>
            <p class="text-sm text-slate-500 mt-1">Buat postingan baru untuk blog CMS.</p>
        </div>
        <a href="/admin/cms/posts" class="px-4 py-2 rounded-lg bg-slate-100 text-slate-700 text-sm font-semibold hover:bg-slate-200 transition-all">Back to Posts</a>
    </div>
    ...
    <form method="POST" action="/admin/cms/posts" class="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-4">
        ...
        <div>
            <label class="block text-sm font-semibold text-slate-700 mb-1" for="excerpt">Excerpt</label>
            <textarea class="w-full border border-slate-300 rounded-lg px-3 py-2" id="excerpt" name="excerpt" rows="3"></textarea>
        </div>
        ...
        <div class="pt-2">
            <button type="submit" class="px-4 py-2 rounded-lg bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 transition-all">Save Post</button>
        </div>
    </form>
</div>
<?php View::endSection(); ?>
